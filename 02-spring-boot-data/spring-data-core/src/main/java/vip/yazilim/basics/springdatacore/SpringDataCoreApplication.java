package vip.yazilim.basics.springdatacore;
...
import vip.yazilim.basics.springdatacore.service.IPersonService;

@SpringBootApplication
public class SpringDataCoreApplication {

    public static void main(String[] args) {
        ConfigurableApplicationContext ctx = SpringApplication.run(SpringDataCoreApplication.class, args);
